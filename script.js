        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '22535168-49bc-4ae7-91ec-ea1751df2b51',
                name: data.name || '',
                email: data.email || '',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "וונג משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '22535168-49bc-4ae7-91ec-ea1751df2b51';
